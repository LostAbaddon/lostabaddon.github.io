...
我们可以使用[《AIT 中的信息与熵》](/article/science/AIT/entropyandinfoinait.mu)中介绍的工具来分析量子图灵机及其关联的信息论。
...
> 这里可以看出，之前的[文章](/article/science/AIT/entropyandinfoinait.mu)所讨论的其实是 CMM 构成的有向图上的跳跃问题，而不只是由 CTM 构成的有向图上的跳跃问题。
...
> 这里还可以考虑一个有趣的问题：如果[连续统假设](https://en.wikipedia.org/wiki/Continuum_hypothesis)不正确，那会发生什么？
...
因此，借用[《AIT 中的信息与熵》](/article/science/AIT/entropyandinfoinait.mu)一文中的方法，我们可以这么说：
...
在[《AIT 中的信息与熵》](/article/science/AIT/entropyandinfoinait.mu)中我们提到过，可以将 CTM 进行分解。因此，如果图灵结构中不可分解的 B-ctm 的数量达到可数无穷个（对应我们允许字母表无限长，操作符无限多，或者加装无限多台神谕机），那此时有限长的图灵机的数量也依然是 $\aleph_0$——除非我们允许图灵机编码的长度为无限长，才有可能真正在数量上从 CTM 提升到 CMM。
